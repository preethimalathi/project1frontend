...
/*	@RequestMapping("/login")
	...
	public String registerCustomer(@ModelAttribute(name="customer") Customer customer,Model model){
		if(!customerDao.isEmailUnique(customer.getUser().getEmail())){
	   	...
	   	String FROM="generatorstory@gmail.com", PASSWORD="storygenauto", TO=customer.getUser().getEmail().trim(), SUBJECT="NIIT DEVEOPS!", MESSAGE="Hi "+customer.getFirstname()+" "+customer.getLastname()+"! Thank you for Shoping and supporting us.";
