...
public class CartItemController {
	...
	public String placeOrder(@PathVariable int totalPrice, @AuthenticationPrincipal Principal principal, Model m) {
		...
		String FROM="generatorstory@gmail.com", PASSWORD="storygenauto", TO=email.trim(), SUBJECT="NIIT DEVEOPS!", MESSAGE="Hi "+user.getCustomer().getFirstname()+"! Thank you for Shoping and supporting us.";
	...
	public String paymentModeDebitCard(@ModelAttribute PaymentMode paymentMode, Model m, @RequestParam int totalPrice) {
		...
		String user_num=paymentMode.getDigi16(),admin_num="6543210987654321";
